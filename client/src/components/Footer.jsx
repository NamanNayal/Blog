...
export default function FooterCom() {
  return (
    <footer className="border-t-8 border-[#5A5AFF]
 bg-[#E6E6FF] text-dark py-6 hover:">
      <div className="w-full max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-sm">
          ...
          <div className="flex gap-6 mt-4 sm:mt-0">
            ...
            <a href="https://x.com/IamNamanNayal" className="text-xl hover:text-blue-400">
              <i className="fab fa-twitter"></i>
            </a>
            <a href="https://github.com/NamanNayal" target="_blank" className="text-xl hover:text-black">
              <i className="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/namannayal" className="text-xl hover:text-blue-800">
